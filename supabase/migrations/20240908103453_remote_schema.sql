...
CREATE POLICY "User can do ALL with ingredients only from their COLLECTION" ON "public"."ingredients" TO "authenticated" USING (("parentDishId" IN ( SELECT "d"."id"
   FROM "public"."dishes" "d",
    "public"."user_metadata" "um"
